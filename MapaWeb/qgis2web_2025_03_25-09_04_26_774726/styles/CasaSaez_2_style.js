...
var style_CasaSaez_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelFill = "#0a080f";
    var bufferColor = "#fa58fa";
    var bufferWidth = 1.0;
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 8.8 + size, points: 5,
            radius2: 4.4, displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(123,29,214,1.0)'})}),
